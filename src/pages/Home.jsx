...
function Home() {
  return (
    <div>
      ...
      <div className=" relative mx-auto flex flex-col w-11/12 items-center text-white justify-between shadow-2xl max-w-maxContent gap-8">
        <Link to="/signup">
          <div className="group mt-16 p-1 mx-auto rounded-full bg-richblack-800 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] font-bold text-richblack-200 transition-all duration-200 hover:scale-95 w-fit ">
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            ...
            <div className="flex flex-col items-start gap-10 lg:w-[40%]">
              <div className="text-[16px]">
                The modern TechNest is the dictates its own terms. Today, to
