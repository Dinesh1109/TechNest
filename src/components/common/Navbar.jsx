...
import Technest from "../../assets/Logo/logoooo.png";
  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        >
          <img src={Technest} width={150} alt="Study Notion" height={85}></img>
        </Link>
        {/* mobile Navbar */}
          ...
          <ul className=" flex-row gap-x-6 text-richblack-25 gap-5 hidden md:flex">
            ...
            >
              <input
                ...
                type="text"
                placeholder="Search"
                className=" absolute top-0 left-10 border-0 focus:ring-1 ring-richblack-400 rounded-full px-4 py-1 text-[15px] w-40 text-richblack-50 focus:outline-none focus:border-transparent bg-richblack-700"
              />
              <HiSearch
                type="submit"
                id="searchicon"
                size={20}
                className=" text-richblack-100 absolute cursor-pointer left-40 top-[5px]"
              />
            </form>
          </ul>
        </nav>
